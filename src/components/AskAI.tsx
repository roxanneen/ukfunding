...
// Brand logo paths (24×24 viewBox), monochrome via currentColor.
// Real marks from the simple-icons set for the three that publish them;
// Grok and Venice fall back to lettermark monograms (no fake logos, no
// external logo API — keeps the site's zero-third-party-request promise).
...
function providers(encoded: string): Provider[] {
  return [
    ...
    { name: 'Grok', href: `https://grok.com/?q=${encoded}`, mono: 'G' },
